    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecipeRestaurantId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RestaurantId = table.Column<int>(type: "int", nullable: false),
                    RecipeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeRestaurant", x => x.RecipeRestaurantId);
                    table.ForeignKey(
                        name: "FK_RecipeRestaurant_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "RecipeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeRestaurant_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeRestaurant_RecipeId",
                table: "RecipeRestaurant",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeRestaurant_RestaurantId",
                table: "RecipeRestaurant",
                column: "RestaurantId");
        }
